  ...
  return (
    ...
    <>
      <nav className='app__navbar'>
        ...
        <div className='app__navbar-login'>
          <a href="#login" className='p-links'>Table-Cart</a>
        </div>
        <div className="app__navbar-smallscreen">
          <GiHamburgerMenu color="#CF0A0A" fontSize={27} onClick={() => setToggleMenu(true)} />
          {toggleMenu && (
            <div className="app__navbar-smallscreen_overlay flex__center slide-bottom">
              ...
              <ul className="app__navbar-smallscreen_links">
                ...
                <li id='app__table-cart'>
                  <a href="#login" className='p-links' onClick={() => setToggleMenu(false)}>Table-Cart</a>
                </li>
              </ul>
